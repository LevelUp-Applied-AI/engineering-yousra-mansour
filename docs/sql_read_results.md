...
The 2024B cohort had the highest average pre-work score. This suggests that this cohort may have entered the program with stronger preparation compared to the others.
...
Aisha Al-Rashidi submitted all three projects on time and achieved consistently high scores in each one. The data shows that she is a reliable and strong performer with steady academic performance.